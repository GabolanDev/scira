...
namespace SCIRA.Controllers
{
    ...
    public class RangoController : Controller
    {
        ...
        // GET: Area
        public ActionResult Index(RangoViewModel model)
        {
            List<RangoViewModel> lista = new List<RangoViewModel>();
            foreach(var item in lista)
            {
                RangoViewModel mod = new RangoViewModel();
                mod.cl_rango = item.cl_rango;
                mod.nb_rango = item.nb_rango;
